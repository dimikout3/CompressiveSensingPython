...
if __name__ == "__main__":
    ...
    for i,s in enumerate(sample_sizes):
        ...
        figMask.savefig(options.fileName.strip('.jpg')+'Mask'+str(s)+'.jpg', cmap='gray')
        plt.close('all')
        ...
        psnrList.append(psnr(Xorig,Z[i]))
        ssimList.append(ssim(Xorig,Z[i]))
        mseList.append(mse(Xorig,Z[i]))
